        ...
        VerleihService
{
    ...
    {
    	assert (mediumImBestand(medium)) : "Die Medien sind nicht vorhanden.";
    ...
    {
    	assert (kundeImBestand(kunde)) : "Der Kunde ist nicht vorhanden.";
    	assert (medienImBestand(medien)) : "Die Medien sind nicht vorhanden.";
    ...
    {
    	assert (sindAlleVerliehen(medien)) : "Eins oder mehrere Medien sind nicht verleihbar.";
    	assert (rueckgabeDatum != null) : "Ungültiges Rückgabedatum.";
    ...
    {
    	assert (kundeImBestand(kunde)) : "Der Kunde ist nicht vorhanden.";
    	assert (sindAlleNichtVerliehen(medien)) : "Eins oder mehrere Medien sind nicht verleihbar.";
    	assert (ausleihDatum != null) : "Ungültiges Ausleihedatum.";
    ...
    {
    	assert (kunde != null) : "Ungültiger Kunde.";
    ...
    {
    	assert (medium != null) : "Ungültiges Medium.";
    ...
    {
    	assert (medien != null) : "Ungültige Liste.";
    	assert (!medien.isEmpty()) : "Leere Liste.";
    ...
    {
    	assert(istVerliehen(medium)) : "Das Medium ist nicht verliehen.";
